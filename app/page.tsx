...
export default async function HomePage() {
  ...
  // For signed-in users, fetch their participations to know which tournaments they're in
...
function TournamentCard({ tournament, player, isAdmin, isMod, myParticipation }: any) {
  ...
  // Decide primary CTA based on combination
  let primary: { label: string; href: string; isAdmin?: boolean } | null = null;
  let secondary: { label: string; href: string; isAdmin?: boolean }[] = [];
